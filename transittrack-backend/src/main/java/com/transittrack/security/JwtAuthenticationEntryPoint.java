...
/**
 * Custom AuthenticationEntryPoint invoked when an unauthenticated user attempts to access a protected resource.
 * Returns HTTP 401 Unauthorized with a structured JSON error body.
 */
@Component
